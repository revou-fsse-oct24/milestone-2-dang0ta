        ...
        <>
            ...
            <PageLayout>
                <div className="p-4 max-w-screen-xl flex flex-col space-y-2">
                    ...
                    <p>Welcome to Shopmart, your go-to online e-commerce platform for all your shopping needs. Built using Next.js, Shadcn, and the Platzi Fake Store API, we aim to provide a seamless and enjoyable shopping experience.</p>
                    <h2 className="font-semibold leading-8 tracking-tight">Our Mission</h2>
                    ...
                    <h2 className="font-semibold leading-8 tracking-tight">Technologies We Use</h2>
                    <ul>
                    ...
                    <h2 className="font-semibold leading-8 tracking-tight">Contact Us</h2>
